  ...
  return (
    <div id="wd-h-tag">
      ...
      <div id="wd-ai-headings">
        <h4>Lab notes</h4>
        This section summarizes practice work with HTML heading tags.
        <h5>What I built</h5>A page that shows heading levels and a short sample
        outline.
        <h6>Next step</h6>
        Continue the lab by adding more HTML elements and structure.
      </div>
